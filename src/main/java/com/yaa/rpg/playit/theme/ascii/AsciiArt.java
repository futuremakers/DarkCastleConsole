package com.yaa.rpg.playit.theme.ascii;
...
public class AsciiArt {
    ...
    public static void drawString(String text,String artChar){
    	 drawString( text, artChar,10);
    }
    public static void drawString(String text,String artChar,int fontSize){
    	Font f=new Font(Font.SANS_SERIF, Font.BOLD, fontSize);
    	Settings settings=new AsciiArt().new Settings(f, 100, 50);
    	AsciiArt ss =new AsciiArt();
		ss.drawString(text, artChar,settings);
    }
